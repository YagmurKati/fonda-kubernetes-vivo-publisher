...
if is_snakemake_engine; then
  setting_names=(
    ...
    JOB_NAME_REGEX EQD_RUN_DIR_PREFIX EQD_PYTHON_VERSION
    WORKFLOW_NAME WORKFLOW_DESCRIPTION WORKFLOW_URI WORKFLOW_REPO_URL CODE_URI
  ...
  setting_names=(
    ...
    TRACE_TIMEZONE WORKFLOW_NAME WORKFLOW_DESCRIPTION WORKFLOW_URI
    WORKFLOW_REPO_URL CODE_URI
    DECLARED_CONTAINER_IMAGES
    ...
    RUN_IDENTITY_SCOPE BACKEND_URI CLUSTER_URI CLUSTER_LABEL ENGINE_URI
    PROM_URL CARBON_SOURCE
