...
| RNA-seq analysis (HISAT2, RS1) | Nextflow | Successful uncached run and VIVO publication: 18/18 tasks, three ENA samples, splice-aware HISAT2 alignment, and complete Prometheus/Kepler coverage | [RNA-seq HISAT2 RS1 profile](examples/rnaseq-hisat2-rs1/README.md) |
